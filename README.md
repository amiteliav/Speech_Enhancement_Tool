...
|--------------------------|----------------------------------------|------------------------------------------|
| [Example 1 - Noisy](examples/Example_1_Noisy.wav) | [Example 1 - keep_speech](examples/Example_1_keep_speech_soft_vad.wav) | [Example 1 - keep_noise](examples/Example_1_keep_noise.wav) |
